...
static struct config_bool ConfigureNamesBool[] =
{
	...
	{
		{"consensus_mode", CFGCXT_INIT, WATCHDOG_CONFIG,
			"Consensus algorithm for leader election: off/false = heuristic (existing watchdog + metrics), on/true = pgraft (Raft consensus).",
			CONFIG_VAR_TYPE_BOOL, false, 0
		},
		&g_pool_config.consensus_mode,
		false,
		NULL, NULL, NULL
	},
